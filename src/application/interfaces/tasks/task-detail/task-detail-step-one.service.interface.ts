import { TaskDetailStepOneDto } from "src/application/dto/tasks/task-detail-step-one/create-task-detail-step-one.dto"
...
export interface ITaskDetailStepOneService {
  createTaskDetailStepOne(createDto: TaskDetailStepOneDto): Promise<TaskDetailStepOne>
